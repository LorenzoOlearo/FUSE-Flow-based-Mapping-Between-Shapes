...
#         points=torch.as_tensor(mesh.vertices[corr], dtype=torch.float32, device=device),
#         vertex_points=None,
#         model=model,
#         mesh=mesh,
#         landmarks=landmarks,
#         corr=corr,
#         dists=dists[corr][:, corr],
#         diameter=diameter,
#     )
